...
- Echo architecture must expose only completed opt-in surfaces; do not expose mode controls, speech recognition, Magic command parsing, AI recommendations, combat prediction, or fake future services from capability metadata alone.
