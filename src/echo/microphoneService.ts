...
import { sleepMs } from "../platform/runtime";
import type {
  AmbientGameplayMode,
...
export function createDefaultEchoVoiceSettings(): EchoVoiceSettings {
  return {
    ...
    combatResolution: createDefaultCombatResolutionSettings(),
    battlefieldActions: createDefaultVoiceBattlefieldActionSettings(),
    pronunciationLearning: createDefaultPronunciationLearningSettings(),
  };
}
...
export function createUnavailableMicrophonePlatformAdapter(): MicrophonePlatformAdapter {
  return {
    platform: "unknown",
...
export class EchoMicrophoneService {
  ...
  private adapter: MicrophonePlatformAdapter;
  ...
  constructor(
    adapter: MicrophonePlatformAdapter = createUnavailableMicrophonePlatformAdapter(),
    options: {
      settings?: EchoVoiceSettings;
      state?: EchoListeningState;
      ambientMode?: AmbientGameplayMode;
  ...
  configurePlatformAdapter(adapter: MicrophonePlatformAdapter): void {
